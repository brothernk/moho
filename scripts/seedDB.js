...
const gifCategories = [
  ...
  },
  {
		...
		color: "#802152",
		theme: ["Epic Quests"],
		categories: ["Trying to make it to Taco Bell at 1:58 a.m. when they close at 2:00 a.m.", "A Rogue battling a Wizard", "Waddling around your friends bathroom in search of a new toilet paper roll"]
  },
  {
		icon: "far fa-frown",
		index: 4,
	...
	},
  {
		...
		categories: ["When you fart in public", "When you slip on ice", "When you pull on a push door", ]
	},
  {
		icon: "fas fa-eye",
		index: 7,
		...
		categories: ["When you have to turn the lights off in the basement and run up the stairs before the darkness consumes you", "When you're home alone and you hear a noise"]
  },
  {
